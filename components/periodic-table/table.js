...
const PeriodicTable = ({ query, rangeMin, rangeMax, categories, elements }) => {
    ...
    console.log(JSON.stringify(rangeMin));
    console.log(JSON.stringify(rangeMax));
        ...
        <div className={styles.periodicTable}>
            {elements.map((element) => {
                ...
                if (rangeMin && rangeMax) {
                    color = interpolateColor(rangeMin, rangeMax, element.answerValue);
                } else {
                    color = categories.find(category => category.name === element.answerValue).hexColour;
                }
                return (
                    <div
                    ...
                    >
                        <Element
                            ...
                            fullName={element.elementName}
                            hexColor={color}
                            customValue={element.answerValue}
                        />
                    </div>
                );
            })}
